...
Siehe hierzu: <a href="https://draeger-it.blog/arduino-ide-einbinden-einer-bibliothek/">https://draeger-it.blog/arduino-ide-einbinden-einer-bibliothek/</a>. Danach nicht vergessen in der Datei "credentials.h" SSID und Passwort des eigenen WLAN einzutragen. Zum Compilieren im Boardverwalter "Heltec Wifi Kit 32(V3)" wählen.
