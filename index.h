...
<button id="btn_reset" type="button" style="margin-left:55px;">Neustart</button>
<div style="padding-top:10px;text-align:center">
<button id="btn_restore" type="button" style="width:100px">Senderliste zurücksetzen</button></div>
</div>
</body>
</html>
)=====";
